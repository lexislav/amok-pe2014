...
<div class="row l-section">
    <div class="m-section_pavilon">
        ...
        <div class="medium-4 columns padded">
            ...
            <p>Architektura pavilonu představuje špičku české modulární architektury.</p>
        </div>
...
<div class="l-section m-progress-bar">
    <div id="drg-progress-bar-bounds" class=" medium-12 columns">
        <div class="row">
            <article>
                <header>
                    <h2>Aktuální stav pavilonu</h2>
                </header>
                <div id="drg-progress-bar" class="m-progress-bar--container">
                    <ul class="m-progress-bar--items">
                        <li style="left: 0px" class="mm-full">
                            <img class="th" src="http://foundation.zurb.com/docs/assets/img/examples/satelite.jpg">
                            <span>24. 5. 2008 popisek popisek popisek popisek popisek popisek</span>
                        </li>
...
<div class="l-section m-section_text">
    <div class="row">
        <article class="medium-6 columns">
            <header>
                <h2>Pavilon v kostce</h2>
            </header>
            <p>Český pavilon EXPO2015 představuje špičkovou českou modulární architekturu. Systém výstavby, který umož- ňuje stavbám souznít se svým okolím po dlouhá léta... </p>
...
<div class="l-section m-section_text mm-dark">
    <div class="row">
        <article class="medium-6 columns">
            <header>
                <h2>Nahlédněte do pavilonu</h2>
            </header>
            <p>Český pavilon EXPO2015 představuje špičkovou českou modulární architekturu. Systém výstavby, který umož- ňuje stavbám souznít se svým okolím po dlouhá léta... </p>
...
<div class="l-section m-section_text">
    <div class="row">
        <article class="medium-6 columns">
            <header><h2>Za konceptem</h2></header>
            <p>Český pavilon EXPO2015 představuje špičkovou českou modulární architekturu. Systém výstavby, který umož- ňuje stavbám souznít se svým okolím po dlouhá léta... </p>
